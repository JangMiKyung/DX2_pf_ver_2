...
HRESULT cScene_04::Init()
{
	...
	D3DXCreateTextureFromFile(
		Device,							//디바이스
		"terrainControl.jpg",			//경로포함한 파일명
		&this->m_pTexControl			//얻어올 IDirect3DTexture9 더블포인터
		);

	D3DXCreateTextureFromFile(
		Device,					//디바이스
		"terrain1.jpg",			//경로포함한 파일명
		&this->m_pTexTile0			//얻어올 IDirect3DTexture9 더블포인터
		);

	D3DXCreateTextureFromFile(
		Device,					//디바이스
		"terrain2.png",			//경로포함한 파일명
		&this->m_pTexTile1			//얻어올 IDirect3DTexture9 더블포인터
		);

	D3DXCreateTextureFromFile(
		Device,					//디바이스
		"terrain3.png",			//경로포함한 파일명
		&this->m_pTexTile2			//얻어올 IDirect3DTexture9 더블포인터
		);

	D3DXCreateTextureFromFile(
		Device,					//디바이스
		"terrain4.png",			//경로포함한 파일명
		&this->m_pTexTile3			//얻어올 IDirect3DTexture9 더블포인터
		);



	//Texture 의 필터모드,D3DTEXF_POINT
	...
	D3DXCreateEffectFromFile(
		Device,						//디바이스
		"Texure_Terrain.fx",		//불러올 셰이더 코드 파일이름
